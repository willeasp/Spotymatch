...
<!-- Most code in this template was authored by Victor Pettersson -->
  <div class="historyShow" v-if="historyExists">
    ...
    <div class="genres header">
        ...
        <div class="songProperties" v-for="property in getSeeds()" :key="property"> 
          <h2>{{(property).charAt(0).toUpperCase() + (property).slice(1)}} </h2>
        </div>
    </div>
  ...
  <div class="historyShow" v-else>
      Please choose a history entry to view.
  </div>
</template>
